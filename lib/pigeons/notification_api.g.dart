...
class NotificationData {
  ...
  bool operator ==(Object other) {
    if (other is! NotificationData || other.runtimeType != runtimeType) {
      return false;
    }
...
class NotificationApi {
  ...
  Future<void> showNotification(NotificationData data) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.pigeon_notification_package.NotificationApi.showNotification$pigeonVar_messageChannelSuffix';
